...
# 3. Load Data
# =========================
TRAIN_FILE = "Dataset/english/mental_english_train_data.xlsx"
TEST_FILE = "Dataset/english/mental_english_test_data.xlsx"

TEXT_COL = "English_Description"
...
training_args = TrainingArguments(
    output_dir="./Model_Run/English/modern_bert_search",
    eval_strategy="epoch",
    save_strategy="no",
    logging_dir="./logs",
...
best_args = TrainingArguments(
    output_dir="./Model_Run/English/best_modern_bert",
    eval_strategy="epoch",
    save_strategy="epoch",
...
OUTPUT_FILE = "./Model_Run/English/modern_bert_test_predictions.xlsx"

test_df[
    ["English_Description", "Actual_Mental_State", "Predicted_Mental_State"]
